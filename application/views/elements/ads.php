        ...
        ?>
                ...
                ?>
                    <li class="xem_nhieu_popup" data-id="<?php echo $post_end->row()->id; ?>" <?php if ($dem_ads % 4 == 0) { ?>style="margin-right:0;" <?php } ?>>
                        <a style="cursor:pointer;" title="<?php echo htmlspecialchars($post_end->row()->title); ?>">
                            <img style="width:100%;" class="img188x117" src="<?php echo $post_end->row()->thumb; ?>" alt="<?php echo htmlspecialchars($post_end->row()->title); ?>" title="<?php echo htmlspecialchars($post_end->row()->title); ?>">
                        </a>
                        <h3 class="name-title">
                            <a style="cursor:pointer;" title="<?php echo htmlspecialchars($post_end->row()->title); ?>"><?php echo catchuoi($post_end->row()->title, 80); ?></a>
                        </h3>
                        <div class="clearfix"></div>
