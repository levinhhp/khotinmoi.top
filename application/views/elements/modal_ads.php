<?php     
    ...
    <p style="font-size:14px;font-weight:bold;border-bottom:1px solid #ededed;padding-bottom:15px;padding-top:8px;text-transform:uppercase;text-align:left;">Tin ngẫu nhiên</p>     
