                            ...
                            foreach($adsNews as $j=>$k){                                
                                ...
                                <?php
                                    ...
                                    <li class="xem_nhieu_popup" data-id="<?php echo $new_end->row()->id; ?>">
                                        <a style="cursor:pointer" title="<?php echo htmlspecialchars($new_end->row()->title); ?>" class="img120x75 pos-rlt" >
                                            <img class="img120x75" src="<?php echo $new_end->row()->thumb; ?>" alt="<?php echo htmlspecialchars($new_end->row()->title); ?>" title="<?php echo htmlspecialchars($new_end->row()->title); ?>">
                                            <span class="number"><?php echo $dem_moi; ?></span>
                                        </a>
                                        <div class="title-box-wc-2018"><a style="cursor:pointer" title="<?php echo htmlspecialchars($new_end->row()->title); ?>"><?php echo catchuoi($new_end->row()->title,80); ?></a></div>
