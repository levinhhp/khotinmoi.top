...
{
	//if ($_SESSION['taikhoan']=="true") return true;
	//else return false;
	return true;
}
...
$config['LicenseName'] = 'khotinmoi.com';
$config['LicenseKey'] = '5CXRPY249M3DMLYABLNCNKMUR8UBEA2H';
...
*/
$baseUrl = "https://khotinmoi.com/upload/";
